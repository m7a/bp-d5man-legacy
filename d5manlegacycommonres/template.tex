...
% Ma_Sys.ma D5Man LaTeX Export Template 1.0.9
...
% TODO z A WORKAROUND TO PREVENT THINGS LIKE INDENTED PARAGRAPH AFTER LIST. WE JUST DISABLE THEM ALL. IT WOULD BE BETTER IF IT WERE POSSIBLE TO RE-ENABLE INDENTED PARAGRAPHS FOR ALL THE PLACES WE WANT THEM AND KEEP THEM DISABLED BETWEEN OTHER ``OBJECTS''
\usepackage{parskip}
...
\usepackage{scrpage2}  % header/footer
